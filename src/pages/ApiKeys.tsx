...
import { Key, Plus, Trash2, Eye, EyeOff, Power, PowerOff, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="h-14 border-b border-border bg-card/80 backdrop-blur-md flex items-center px-4 gap-4 sticky top-0 z-50">
        ...
        <Key className="w-5 h-5 text-primary cyber-glow-text" />
      ...
      <main className="flex-1 p-6 max-w-4xl mx-auto w-full space-y-6">
        <div className="flex items-center justify-between">
          <p className="text-sm text-muted-foreground">Manage API keys for threat intelligence feeds and integrations.</p>
